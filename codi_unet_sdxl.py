...
class CoDiSDXLUNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
    ...
    def enable_freeu(self, s1, s2, b1, b2): #FreeU 通过调整模型的跳跃连接（skip connections）和主干特征（backbone features）的贡献，来增强扩散模型的去噪过程并减轻过度平滑效应。
